...
def mnasnet0_5_baseline_att(cmap_channels, paf_channels, upsample_channels=256, pretrained=False, num_upsample=3, num_flat=0): # True
    backbone = torchvision.models.mnasnet0_5(pretrained=pretrained)
    return _mnasnet_pose_att(cmap_channels, paf_channels, upsample_channels, backbone, 1280, num_upsample, num_flat)


def mnasnet0_75_baseline_att(cmap_channels, paf_channels, upsample_channels=256, pretrained=False, num_upsample=3, num_flat=0):
    backbone = torchvision.models.mnasnet0_75(pretrained=pretrained)
    return _mnasnet_pose_att(cmap_channels, paf_channels, upsample_channels, backbone, 1280, num_upsample, num_flat)


def mnasnet1_0_baseline_att(cmap_channels, paf_channels, upsample_channels=256, pretrained=False, num_upsample=3, num_flat=0):
    backbone = torchvision.models.mnasnet1_0(pretrained=pretrained)
    return _mnasnet_pose_att(cmap_channels, paf_channels, upsample_channels, backbone, 1280, num_upsample, num_flat)


def mnasnet1_3_baseline_att(cmap_channels, paf_channels, upsample_channels=256, pretrained=False, num_upsample=3, num_flat=0):
    backbone = torchvision.models.mnasnet1_3(pretrained=pretrained)
    return _mnasnet_pose_att(cmap_channels, paf_channels, upsample_channels, backbone, 1280, num_upsample, num_flat)